  ...
  return (
    <div className='my-40 px-4'>
      <Slider {...settings}>
        ...
        >
          <h2 className='text-center text-4xl text-red-500 mb-4'>About Our Staff</h2>
        ...
        >
          <h2 className='text-center text-4xl text-red-500 mb-4'>Expertise at Your Service</h2>
          <p className='text-center text-xl'>
        ...
        >
          <h2 className='text-center text-4xl text-red-500 mb-4'>Customer-Centric Approach</h2>
          <p className='text-center text-xl'>
